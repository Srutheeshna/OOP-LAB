...
class TestFile
{
	...
	{
		File f1=new File("C:\\Users\\swapn\\Desktop\\javaprgrms");
		if(f1.isDirectory())
		{
	   ...
	   {
		   System.out.println("C:\\Users\\swapn\\Desktop\\javaprgrms" + " is not a directory");
	   }
...
boolean f=false;
	...
	{
		File f2=new File("C:\\Users\\swapn\\Desktop\\javaprgrms"+"//"+filelist[i]);
